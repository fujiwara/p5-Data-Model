...
is $model->get_driver('tusr'), $base_driver, 'tusr driver ok';
is $model->get_driver('bookmark'), $base_driver, 'bookmark driver ok';
is $model->get_driver('bookmark_tusr'), $base_driver, 'bookmark_tusr driver ok';
...
$model->set_base_driver($new_driver);
is $model->get_driver('tusr'), $new_driver, 'tusr driver ok';
is $model->get_driver('bookmark'), $new_driver, 'bookmark driver ok';
is $model->get_driver('bookmark_tusr'), $new_driver, 'bookmark_tusr driver ok';
